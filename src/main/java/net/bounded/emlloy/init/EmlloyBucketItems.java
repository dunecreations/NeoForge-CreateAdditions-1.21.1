...
import net.bounded.emlloy.item.MoltenBrassBucket;
...
public class EmlloyBucketItems {
	...
	public static final DeferredItem<Item> MOLTEN_BRASS_BUCKET;
	static {
		MOLTEN_BRASS_BUCKET = REGISTRY.register("molten_brass_bucket", MoltenBrassBucket::new);
	}
	...
	public static void registerCapabilities(RegisterCapabilitiesEvent event) {
		...
		event.registerItem(Capabilities.FluidHandler.ITEM, (stack, context) -> new FluidBucketWrapper(stack), MOLTEN_BRASS_BUCKET.get());
	}
}