...
@Mod(CreateAdditions.MOD_ID)
public class CreateAdditions {
    public static final String MOD_ID = "createadditions";
    public static final Logger LOGGER = LogUtils.getLogger();

    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public CreateAdditions(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = CreateAdditions.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
